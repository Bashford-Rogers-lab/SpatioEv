"""
Supplementary Figure 1F — T cell subtype proximity along pseudotime
====================================================================
...
Run:
    python notebooks/suppfig1F_tcell_subtypes.py

Output: paper/notebooks/results/pseudotime_exp2/suppfig1F_tcell_subtypes.pdf (.png)
"""
...
def make_figure():
    ...
    out_pdf = RESULT_DIR / "suppfig1F_tcell_subtypes.pdf"
    out_png = RESULT_DIR / "suppfig1F_tcell_subtypes.png"
