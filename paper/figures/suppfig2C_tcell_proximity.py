"""
Supplementary Figure 2C — T cell subtype proximity along pseudotime
====================================================================
Fraction of ductal cells with ≥1 Tier B T cell subset neighbour within 30 µm,
...
Data source: tier_b_t_cells_interaction_bins.csv
  x = pseudotime_median (bin centre)
  y = fraction_source_with_target_neighbor

Run:
    python notebooks/suppfig2C_tcell_proximity.py

Output: paper/notebooks/results/pseudotime_exp2/suppfig2C_tcell_proximity.pdf (.png)
"""
...
BINS_CSV = RESULT_DIR / "tier_b_t_cells_interaction_bins.csv"

# ── Subtype definitions — (target_phenotype, label, colour) ──────────────────
SUBTYPES = [
    ("activated CD4 T cells",  "Act. CD4 T cells",    "#e41a1c"),
    ("activated CD8 T cells",  "Act. CD8 T cells",    "#377eb8"),
    ("CD8 T cells",            "CD8 T cells",          "#4daf4a"),
    ("CD4 T cells",            "CD4 T cells",          "#984ea3"),
    ("Tregs",                  "Tregs",                "#ff7f00"),
    ("Th2-like cells",         "Th2-like",             "#a65628"),
    ("cytotoxic CD8 T cells",  "Cytotoxic CD8",        "#666666"),
]
...
def make_figure():
    ...
    for idx, (phenotype, label, color) in enumerate(SUBTYPES):
        ...
        # Spearman ρ across bins (using bin index for monotone test)
        if len(x) >= 4:
    ...
    # Footnote
    fig.text(0.5, 0.005,
             "Proximity: fraction of ductal cells with ≥1 T cell subtype neighbour within 30 µm",
    ...
    out_pdf = RESULT_DIR / "suppfig2C_tcell_proximity.pdf"
    out_png = RESULT_DIR / "suppfig2C_tcell_proximity.png"
