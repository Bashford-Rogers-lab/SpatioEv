...
All pre-computed results live in:
  notebooks/results/ra_oa_ecm_cell/spatioev_module_paper_applications/tables/
  notebooks/results/ra_oa_ecm_cell/chp_density_micro_holes_col6_dark_segmentation/outputs/
