"""Vendored from scimap — scimap/tools/phenotype_cells.py

Upstream: https://github.com/labsyspharm/scimap  (master @ 4df3a67fa63e)
Copyright (c) 2023 Laboratory of Systems Pharmacology @ Harvard
Licensed under the MIT License; see LICENSE in this directory.

Vendored so that SpatioEv can offer prior-knowledge phenotyping without
depending on the full scimap distribution, which pulls in ~28 transitive
packages (napari, PyQt6, numba, gensim, PhenoGraph, ...) and pins
zarr==2.10.3. This module needs only numpy, pandas, sklearn and anndata,
all of which are already SpatioEv core dependencies.
